...
public class FoundryCastingCategory implements IRecipeCategory<FoundryCastingJeiRecipe> {
    public static final RecipeType<FoundryCastingJeiRecipe> TYPE = RecipeType.create(
            CreateExpansion.MOD_ID,
            "foundry_casting",
            FoundryCastingJeiRecipe.class
    );
    ...
    public FoundryCastingCategory(IGuiHelper guiHelper) {
    ...
    public Component getTitle() {
        return Component.literal("Foundry Casting");
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, FoundryCastingJeiRecipe recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.CATALYST, 54, 27)
                .setBackground(CreateRecipeCategory.getRenderedSlot(), -1, -1)
                .addItemStacks(recipe.molds());
    ...
    @Override
    public void draw(FoundryCastingJeiRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics graphics, double mouseX, double mouseY) {
