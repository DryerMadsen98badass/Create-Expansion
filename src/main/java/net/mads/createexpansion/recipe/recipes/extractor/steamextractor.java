...
public final class steamextractor {

    private steamextractor() {
    }
    ...
    public static void build(
        ...
        recipe("raw_resin_from_oak_saplings")
                .recipeDefinition(RecipeDefinition.Option.inputItem("minecraft:oak_sapling", 4))
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:raw_resin", 100))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:wet_biomass", 1))
                .recipeDefinition(RecipeDefinition.Option.duration(180))
                .save(output);

        recipe("raw_resin_from_spruce_saplings")
                .recipeDefinition(RecipeDefinition.Option.inputItem("minecraft:spruce_sapling", 4))
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:raw_resin", 150))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:wet_biomass", 1))
                .recipeDefinition(RecipeDefinition.Option.duration(180))
                .save(output);

        recipe("raw_resin_from_birch_saplings")
                .recipeDefinition(RecipeDefinition.Option.inputItem("minecraft:birch_sapling", 4))
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:raw_resin", 100))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:wet_biomass", 1))
                .recipeDefinition(RecipeDefinition.Option.duration(180))
                .save(output);

        recipe("raw_resin_from_jungle_saplings")
                .recipeDefinition(RecipeDefinition.Option.inputItem("minecraft:jungle_sapling", 4))
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:raw_resin", 125))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:wet_biomass", 1))
                .recipeDefinition(RecipeDefinition.Option.duration(180))
                .save(output);

        recipe("raw_resin_from_acacia_saplings")
                .recipeDefinition(RecipeDefinition.Option.inputItem("minecraft:acacia_sapling", 4))
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:raw_resin", 100))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:wet_biomass", 1))
                .recipeDefinition(RecipeDefinition.Option.duration(180))
                .save(output);

        recipe("raw_resin_from_dark_oak_saplings")
                .recipeDefinition(RecipeDefinition.Option.inputItem("minecraft:dark_oak_sapling", 4))
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:raw_resin", 125))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:wet_biomass", 1))
                .recipeDefinition(RecipeDefinition.Option.duration(180))
                .save(output);

        recipe("raw_resin_from_cherry_saplings")
                .recipeDefinition(RecipeDefinition.Option.inputItem("minecraft:cherry_sapling", 4))
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:raw_resin", 100))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:wet_biomass", 1))
                .recipeDefinition(RecipeDefinition.Option.duration(180))
                .save(output);

        recipe("raw_resin_from_mangrove_propagules")
                .recipeDefinition(RecipeDefinition.Option.inputItem("minecraft:mangrove_propagule", 4))
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:raw_resin", 125))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:wet_biomass", 1))
                .recipeDefinition(RecipeDefinition.Option.duration(180))
                .save(output);
        ...
        recipe("fermentation_mash_from_sugar_cane")
                ...
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:fermentation_mash", 250))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:wet_biomass", 1))
        ...
        recipe("fermentation_mash_from_beetroots")
                ...
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:fermentation_mash", 225))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:wet_biomass", 1))
                .recipeDefinition(RecipeDefinition.Option.duration(200))
                .save(output);
        ...
        recipe("fermentation_mash_from_potatoes")
                ...
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:fermentation_mash", 200))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:wet_biomass", 1))
                .recipeDefinition(RecipeDefinition.Option.duration(220))
                .save(output);
        ...
        recipe("fermentation_mash_from_pumpkin")
                ...
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:fermentation_mash", 175))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:wet_biomass", 1))
                .recipeDefinition(RecipeDefinition.Option.duration(200))
                .save(output);
        ...
        recipe("fermentation_mash_from_sweet_berries")
                ...
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:fermentation_mash", 150))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:wet_biomass", 1))
                .recipeDefinition(RecipeDefinition.Option.duration(180))
                .save(output);
        ...
        recipe("plant_oil_from_wheat_seeds")
                ...
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:plant_oil", 75))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:biomass", 1))
                .recipeDefinition(RecipeDefinition.Option.duration(100))
                .save(output);
        ...
        recipe("plant_oil_from_melon_seeds")
                ...
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:plant_oil", 100))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:biomass", 1))
                .recipeDefinition(RecipeDefinition.Option.duration(100))
                .save(output);
        ...
        recipe("plant_oil_from_torchflower_seeds")
                ...
                .recipeDefinition(RecipeDefinition.Option.outputFluid("create_expansion:plant_oil", 125))
                .recipeDefinition(RecipeDefinition.Option.outputItem("create_expansion:biomass", 1))
    ...
    private static RecipeDefinition recipe(String id) {
        return RecipeDefinition.recipe()
                .recipeDefinition(RecipeDefinition.Option.id("steam_extractor/" + id))
                .recipeDefinition(RecipeDefinition.Option.recipeType(CERecipeTypes.STEAM_EXTRACTOR));
    }
}