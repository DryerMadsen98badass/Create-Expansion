...
public class CreateRecipeBuilder {
    ...
    private CreateRecipeBuilder(List<CompletableFuture<?>> futures, CachedOutput output, PackOutput.PathProvider recipes, String recipeId, String type) {
    ...
    public static CreateRecipeBuilder cutting(List<CompletableFuture<?>> futures, CachedOutput output, PackOutput.PathProvider recipes, String recipeId) {
        return create(futures, output, recipes, recipeId, "cutting");
    }

    public static CreateRecipeBuilder pressing(List<CompletableFuture<?>> futures, CachedOutput output, PackOutput.PathProvider recipes, String recipeId) {
        return create(futures, output, recipes, recipeId, "pressing");
    }

    public static CreateRecipeBuilder crushing(List<CompletableFuture<?>> futures, CachedOutput output, PackOutput.PathProvider recipes, String recipeId) {
        return create(futures, output, recipes, recipeId, "crushing");
    }

    public static CreateRecipeBuilder milling(List<CompletableFuture<?>> futures, CachedOutput output, PackOutput.PathProvider recipes, String recipeId) {
        return create(futures, output, recipes, recipeId, "milling");
    }

    public static CreateRecipeBuilder mixing(List<CompletableFuture<?>> futures, CachedOutput output, PackOutput.PathProvider recipes, String recipeId) {
        return create(futures, output, recipes, recipeId, "mixing");
    }

    public static CreateRecipeBuilder deploying(List<CompletableFuture<?>> futures, CachedOutput output, PackOutput.PathProvider recipes, String recipeId) {
        return create(futures, output, recipes, recipeId, "deploying");
    }

    public static CreateRecipeBuilder filling(List<CompletableFuture<?>> futures, CachedOutput output, PackOutput.PathProvider recipes, String recipeId) {
        return create(futures, output, recipes, recipeId, "filling");
    }

    public static CreateRecipeBuilder compacting(List<CompletableFuture<?>> futures, CachedOutput output, PackOutput.PathProvider recipes, String recipeId) {
        return create(futures, output, recipes, recipeId, "compacting");
    }

    public static CreateRecipeBuilder sequencedAssembly(List<CompletableFuture<?>> futures, CachedOutput output, PackOutput.PathProvider recipes, String recipeId) {
        return create(futures, output, recipes, recipeId, "sequenced_assembly");
    }

    private static CreateRecipeBuilder create(List<CompletableFuture<?>> futures, CachedOutput output, PackOutput.PathProvider recipes, String recipeId, String type) {
        return new CreateRecipeBuilder(futures, output, recipes, recipeId, "create:" + type);
    }
    ...
    public CreateRecipeBuilder outputFluid(String id, int amount) {
        lastResult = CreateRecipeJson.fluid(id, amount);
        results.add(lastResult);
        return this;
    }
    ...
    public CreateRecipeBuilder chance(float chance) {
        if (lastResult == null) {
            throw new IllegalStateException("chance() must be called after outputItem() or outputFluid()");
        }
    ...
    public void save() {
        ...
        CreateRecipeJson.save(futures, output, recipes, recipeId, json);
    }
}
