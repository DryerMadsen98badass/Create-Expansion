...
final class OreDepositDefinitions {
    ...
    static final List<OreDeposit> ALL = List.of(
            ...
            deposit("lapis", 20, -64, 32, 13, 0.07,
                    groups(CAVES, MOUNTAINS),
                    layer(LAZURITE, 65), layer(SODALITE, 25), layer(PYRITE, 10)),
            deposit("nether_quartz", 60, 8, 120, 18, 0.11,
                    groups(NETHER),
                    layer(QUARTZ, 80), layer(SULFUR, 12), layer(NATIVE_GOLD, 8)),
            deposit("nether_gold", 35, 8, 96, 15, 0.08,
                    groups(NETHER),
            ...
            deposit("nether_sulfur", 25, 8, 96, 14, 0.08,
                    groups(NETHER),
            ...
            deposit("end_rare_earth", 15, 16, 96, 13, 0.06,
                    groups(END),
